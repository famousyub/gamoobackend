...
public class UserEntity extends BaseEntity implements Serializable {
    ...
    @Column(name = "technicien" , nullable = true, updatable = true)
    private String technicien;

    public UserEntity(String username, String email, List<UserRoleEntity> roles, String password, String role, String technicien) {
